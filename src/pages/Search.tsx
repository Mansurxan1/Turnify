...
const Search = () => {
  ...
  return (
    <div className={`${theme === "dark" ? "bg-[#182533] text-white" : "bg-[#D2D2D2] text-black"} h-screen max-w-[450px] mx-auto`}>
        <form action="" className='px-5 py-4 w-full shadow-[0px_0.33px_0.33px_0px_rgb(118,140,158,0.25)] bg-[#F1F1F1]'>
            <div className='bg-[#FFFFFF] rounded-[8px] flex items-center px-3'>
                <span>🔍</span>
                ...
                <div className='p-5 flex flex-col gap-5'>
                    ...
                    <div className='flex items-center justify-between'>
                        <div className='flex gap-1'>
                            <span>📄</span>
                            <p
                             className='font-inter font-bold text-sm'>3</p>
                        </div>
                        <div className='flex gap-1 items-center'>
                            <span>👁️</span>
                            <p
                             className='font-inter font-bold text-sm'>700</p>
                        </div>
                        <div>
                            <p
                             className='font-inter font-bold text-sm'><span>&#128101;</span> 700K</p>
                        </div>
                        <div>
                            <p className='font-inter font-bold text-sm'><span className='text-[#FD9400]'>&#9733;</span> 4.5</p>
                        </div>
                    </div>
                </div>
            </div>
            <div className={`bg-white rounded-xl p-5 flex`}>
                ...
                <div className='flex-1 flex flex-col'>
                    <h3 className='font-inter font-bold'>Muhammad Said <span className='bg-custom-gradient px-1 text-white'> &#10004; </span></h3>
